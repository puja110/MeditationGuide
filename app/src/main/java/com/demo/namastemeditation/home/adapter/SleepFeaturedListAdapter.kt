...
class SleepFeaturedListAdapter(val itemList: ArrayList<SleepFeaturedResponse>) :
    RecyclerView.Adapter<SleepFeaturedListAdapter.ModelViewHolder>() {

    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): SleepFeaturedListAdapter.ModelViewHolder {

        val v =
            LayoutInflater.from(parent.context).inflate(R.layout.item_sleep_featured, parent, false)
        return ModelViewHolder(v)
    }

    override fun onBindViewHolder(holder: SleepFeaturedListAdapter.ModelViewHolder, position: Int) {
